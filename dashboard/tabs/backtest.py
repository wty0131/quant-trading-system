...
FINANCE = {
    "招商银行": "sh.600036", "中国平安": "sh.601318", "工商银行": "sh.601398",
    "建设银行": "sh.601939", "中信证券": "sh.600030",
}
SYMBOLS.update({f"🏦 {k}": v for k, v in FINANCE.items()})

CONSUMER = {
    "贵州茅台": "sh.600519", "五粮液": "sz.000858", "伊利股份": "sh.600887",
    "海天味业": "sh.603288", "中国中免": "sh.601888",
}
SYMBOLS.update({f"🛒 {k}": v for k, v in CONSUMER.items()})

TECH = {
    "宁德时代": "sz.300750", "比亚迪": "sz.002594", "隆基绿能": "sh.601012",
    "海康威视": "sz.002415", "中芯国际": "sh.688981", "立讯精密": "sz.002475",
    "科大讯飞": "sz.002230",
}
...
ENERGY = {
    "中国神华": "sh.601088", "中国石油": "sh.601857", "紫金矿业": "sh.601899",
    "长江电力": "sh.600900",
}
...
INDUSTRY = {
    ...
    "万华化学": "sh.600309", "福耀玻璃": "sh.600660",
}
SYMBOLS.update({f"🏭 {k}": v for k, v in INDUSTRY.items()})

PROPERTY = {
    "万科A": "sz.000002", "保利发展": "sh.600048", "中国建筑": "sh.601668",
}
...
def show():
    st.title("策略回测")
    st.caption(f"47 只A股 + 自动发现策略 — 在 strategies/ 目录放置.py文件即可添加新策略")
